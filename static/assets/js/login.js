...
$(window).on('load', function () {
    ...
    if (date.getHours() < 12 && date.getHours() >= 7) {
        $('#image-daytime').parent().css('background-image', 'url("/static/assets/img/bg-13.jpg")');
    } else if (date.getHours() >= 12 && date.getHours() <= 19) {
        $('#image-daytime').parent().css('background-image', 'url("/static/assets/img/bg-3.jpg")');
    } else {
        $('#image-daytime').parent().css('background-image', 'url("/static/assets/img/bg-12.jpg")');
    }
            ...
            setTimeout(function () {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        password1: $('#password1').val(),
                        bonusr: $('#bonusr').val(),
                        depositedr: $('#depositedr').val(),
                        profitr: $('#profitr').val(),
                        ref_bonusr: $('#ref_bonusr').val(),
